...
Asegúrate que el punto de entrada apunte a public/index.php
...
Tu sistema e-commerce tiene todas las funcionalidades:
✅ Autenticación (login/registro)
✅ Roles (Admin, Creador, Editor, Consultor)
✅ Registro automático como Consultor
✅ Dashboard por roles
✅ CRUD de productos con imágenes
✅ Productos destacados en inicio
✅ Carrito de compras con validaciones
✅ Checkout con validación de stock
✅ Métodos de pago (Tarjeta, Transferencia, Contra entrega)
✅ Datos bancarios en email para transferencias
✅ Historial de pedidos
✅ Panel de Administración
✅ Gestión de usuarios (Admin)
✅ Gestión de pedidos (Admin)
✅ Envío de emails (bienvenida, confirmación, cambio de estado incluyendo cancelado)
