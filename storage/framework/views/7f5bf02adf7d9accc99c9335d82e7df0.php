...
<head>
    ...
    <title>Detalle Pedido <?php echo e($pedido->numero_pedido); ?></title>
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex justify-between h-16">
                    <div class="flex items-center">
                        ...
                        <a href="<?php echo e(route('admin.pedidos.index')); ?>" class="ml-4 text-gray-500 hover:text-gray-700">← Volver</a>
                    </div>
                ...
                <div class="p-6">
                    <div class="grid grid-cols-2 gap-4 mb-6">
                        <div>
                            ...
                            <p class="font-bold text-lg"><?php echo e($pedido->numero_pedido); ?></p>
                        </div>
                        <div>
                            <p class="text-gray-600 text-sm">Cliente</p>
                            <p class="font-bold"><?php echo e($pedido->user->name); ?></p>
                            <p class="text-sm text-gray-500"><?php echo e($pedido->user->email); ?></p>
                        </div>
                        <div>
                            <p class="text-gray-600 text-sm">Fecha</p>
                            <p class="font-bold"><?php echo e($pedido->created_at->format('d/m/Y H:i')); ?></p>
                        </div>
                        <div>
                            <p class="text-gray-600 text-sm">Método de pago</p>
                            <p class="font-bold"><?php echo e(ucfirst($pedido->metodo_pago)); ?></p>
                        </div>
                    </div>

                    <div class="mb-6">
                        <h3 class="font-bold text-lg mb-3">Cambiar Estado</h3>
                        <form action="<?php echo e(route('admin.pedidos.estado', $pedido)); ?>" method="POST" class="flex items-center space-x-4">
                            <?php echo csrf_field(); ?>
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td class="py-2"><?php echo e($detalle->producto_nombre); ?></td>
                                <td class="py-2">$<?php echo e(number_format($detalle->producto_precio, 2)); ?></td>
                                <td class="py-2"><?php echo e($detalle->cantidad); ?></td>
                                <td class="py-2">$<?php echo e(number_format($detalle->subtotal, 2)); ?></td>
                            </tr>
                        ...
                        <tfoot>
                            <tr>
                                ...
                                <td class="pt-4 font-bold text-green-600">$<?php echo e(number_format($pedido->total, 2)); ?></td>
                            </tr>
                        </tfoot>
                    </table>
                    ...
                    <div class="border-t pt-4 mt-4">
                        ...
                        <p class="text-gray-700"><?php echo e($pedido->direccion_envio); ?></p>
                    </div>
                </div>
            </div>
        </div>
...
</html><?php /**PATH D:\desarrollo\cc2f4\cc2f4\resources\views/admin/pedidos/show.blade.php ENDPATH**/ ?>