            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex justify-between h-16">
                    ...
                    <div class="flex items-center space-x-4">
                        ...
                        <a href="<?php echo e(route('admin.pedidos.index')); ?>" class="text-gray-600 hover:text-gray-800">📦 Gestionar Pedidos</a>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
                ...
                <div class="bg-white rounded-lg shadow p-6">
                    ...
                    <a href="#" class="text-blue-500 hover:text-blue-700 mt-4 inline-block">Ver todos →</a>
                </div>

                <!-- Tarjeta 2: Roles -->
                <div class="bg-white rounded-lg shadow p-6">
                    <h3 class="text-lg font-semibold mb-2">Roles</h3>
                    <p class="text-3xl font-bold text-green-600"><?php echo e(\Spatie\Permission\Models\Role::count()); ?></p>
                    <p class="text-gray-600 mt-2">Roles disponibles</p>
                    <a href="#" class="text-blue-500 hover:text-blue-700 mt-4 inline-block">Gestionar →</a>
                </div>
                ...
                <div class="bg-white rounded-lg shadow p-6">
                    ...
                    <a href="<?php echo e(route('productos.index')); ?>" class="text-blue-500 hover:text-blue-700 mt-4 inline-block">Gestionar →</a>
                </div>

                <!-- Tarjeta 4: Pedidos -->
                <div class="bg-white rounded-lg shadow p-6">
                    <h3 class="text-lg font-semibold mb-2">Pedidos</h3>
                    <p class="text-3xl font-bold text-orange-600"><?php echo e(\App\Models\Pedido::count()); ?></p>
