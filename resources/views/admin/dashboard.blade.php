        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div class="bg-white rounded-lg shadow p-6">
                    ...
                    <p class="text-3xl font-bold text-green-600">{{ \Spatie\Permission\Models\Role::count() }}</p>
                ...
                <div class="bg-white rounded-lg shadow p-6">
                    ...
                    <a href="{{ route('productos.index') }}" class="text-blue-500 hover:text-blue-700 mt-4 inline-block">Gestionar →</a>
                </div>
            </div>
